...
module soc_system_mm_interconnect_1 (
	...
	wire  [114:0] modular_sgdma_dispatcher_0_csr_agent_rf_source_data;                             // modular_sgdma_dispatcher_0_CSR_agent:rf_source_data -> modular_sgdma_dispatcher_0_CSR_agent_rsp_fifo:in_data
	...
	wire  [114:0] modular_sgdma_dispatcher_0_csr_agent_rsp_fifo_out_data;                          // modular_sgdma_dispatcher_0_CSR_agent_rsp_fifo:out_data -> modular_sgdma_dispatcher_0_CSR_agent:rf_sink_data
	...
	wire  [222:0] modular_sgdma_dispatcher_0_descriptor_slave_agent_rf_source_data;                // modular_sgdma_dispatcher_0_Descriptor_Slave_agent:rf_source_data -> modular_sgdma_dispatcher_0_Descriptor_Slave_agent_rsp_fifo:in_data
	...
	wire  [222:0] modular_sgdma_dispatcher_0_descriptor_slave_agent_rsp_fifo_out_data;             // modular_sgdma_dispatcher_0_Descriptor_Slave_agent_rsp_fifo:out_data -> modular_sgdma_dispatcher_0_Descriptor_Slave_agent:rf_sink_data
	...
	wire  [113:0] modular_sgdma_dispatcher_0_csr_agent_rp_data;                                    // modular_sgdma_dispatcher_0_CSR_agent:rp_data -> router_002:sink_data
	...
	wire  [221:0] modular_sgdma_dispatcher_0_descriptor_slave_agent_rp_data;                       // modular_sgdma_dispatcher_0_Descriptor_Slave_agent:rp_data -> router_003:sink_data
	...
	wire  [113:0] cmd_mux_src_data;                                                                // cmd_mux:src_data -> modular_sgdma_dispatcher_0_CSR_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                                               // modular_sgdma_dispatcher_0_CSR_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                                             // cmd_mux:src_channel -> modular_sgdma_dispatcher_0_CSR_burst_adapter:sink0_channel
	...
	wire  [113:0] modular_sgdma_dispatcher_0_csr_burst_adapter_source0_data;                       // modular_sgdma_dispatcher_0_CSR_burst_adapter:source0_data -> modular_sgdma_dispatcher_0_CSR_agent:cp_data
	...
	wire    [1:0] modular_sgdma_dispatcher_0_csr_burst_adapter_source0_channel;                    // modular_sgdma_dispatcher_0_CSR_burst_adapter:source0_channel -> modular_sgdma_dispatcher_0_CSR_agent:cp_channel
	...
	wire  [221:0] modular_sgdma_dispatcher_0_descriptor_slave_burst_adapter_source0_data;          // modular_sgdma_dispatcher_0_Descriptor_Slave_burst_adapter:source0_data -> modular_sgdma_dispatcher_0_Descriptor_Slave_agent:cp_data
	...
	wire    [1:0] modular_sgdma_dispatcher_0_descriptor_slave_burst_adapter_source0_channel;       // modular_sgdma_dispatcher_0_Descriptor_Slave_burst_adapter:source0_channel -> modular_sgdma_dispatcher_0_Descriptor_Slave_agent:cp_channel
	...
	wire  [221:0] router_003_src_data;                                                             // router_003:src_data -> modular_sgdma_dispatcher_0_Descriptor_Slave_rsp_width_adapter:in_data
	wire          router_003_src_ready;                                                            // modular_sgdma_dispatcher_0_Descriptor_Slave_rsp_width_adapter:in_ready -> router_003:src_ready
	wire    [1:0] router_003_src_channel;                                                          // router_003:src_channel -> modular_sgdma_dispatcher_0_Descriptor_Slave_rsp_width_adapter:in_channel
	...
	wire  [113:0] modular_sgdma_dispatcher_0_descriptor_slave_rsp_width_adapter_src_data;          // modular_sgdma_dispatcher_0_Descriptor_Slave_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	...
	wire    [1:0] modular_sgdma_dispatcher_0_descriptor_slave_rsp_width_adapter_src_channel;       // modular_sgdma_dispatcher_0_Descriptor_Slave_rsp_width_adapter:out_channel -> rsp_demux_001:sink_channel
	...
	wire  [113:0] cmd_mux_001_src_data;                                                            // cmd_mux_001:src_data -> modular_sgdma_dispatcher_0_Descriptor_Slave_cmd_width_adapter:in_data
	wire          cmd_mux_001_src_ready;                                                           // modular_sgdma_dispatcher_0_Descriptor_Slave_cmd_width_adapter:in_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                                         // cmd_mux_001:src_channel -> modular_sgdma_dispatcher_0_Descriptor_Slave_cmd_width_adapter:in_channel
	...
	wire  [221:0] modular_sgdma_dispatcher_0_descriptor_slave_cmd_width_adapter_src_data;          // modular_sgdma_dispatcher_0_Descriptor_Slave_cmd_width_adapter:out_data -> modular_sgdma_dispatcher_0_Descriptor_Slave_burst_adapter:sink0_data
	...
	wire    [1:0] modular_sgdma_dispatcher_0_descriptor_slave_cmd_width_adapter_src_channel;       // modular_sgdma_dispatcher_0_Descriptor_Slave_cmd_width_adapter:out_channel -> modular_sgdma_dispatcher_0_Descriptor_Slave_burst_adapter:sink0_channel
