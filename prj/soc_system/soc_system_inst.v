	soc_system u0 (
		...
		.dma_avalon_source_data          (<connected-to-dma_avalon_source_data>),          // dma_avalon_source.data
		.dma_avalon_source_valid         (<connected-to-dma_avalon_source_valid>),         //                  .valid
		.dma_avalon_source_ready         (<connected-to-dma_avalon_source_ready>),         //                  .ready
		.dma_avalon_source_startofpacket (<connected-to-dma_avalon_source_startofpacket>), //                  .startofpacket
		.dma_avalon_source_endofpacket   (<connected-to-dma_avalon_source_endofpacket>),   //                  .endofpacket
		.dma_avalon_source_empty         (<connected-to-dma_avalon_source_empty>),         //                  .empty
